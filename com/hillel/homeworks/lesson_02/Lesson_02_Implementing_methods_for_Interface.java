...
public class Lesson_02_Implementing_methods_for_Interface {
	private static final String TASK00 = "Написать interface IntList и его реализацию IntArrayList - аналог List<Integer>.";
...
//		Implement method add(int element)
		...
		System.out.println("Adding random element of random (0,1,2) to list");
